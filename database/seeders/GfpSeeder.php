...
class GfpSeeder extends Seeder
{
    public function run(): void
    {
        $structures = [
            ...
            ['code' => 'DSI', 'nom' => 'Direction des Systèmes d’Information', 'type' => 'Direction'],
            ['code' => 'SD-PERS', 'nom' => 'Sous-Direction du Personnel', 'type' => 'Sous-Direction'],
        ...
        $privileges = [
            ...
            ['code' => 'PERM_VERIFIER', 'libelle' => 'Vérifier conformité RH', 'module' => 'PERMISSIONS'],
        ...
        $comptes = [
            ['matricule' => 'AGT001', 'nom' => 'GRAMBOUTE', 'prenom' => 'Mohamed', 'role' => 'ROLE_AGENT', 'structure' => 'SERV-ETUDES'],
            ['matricule' => 'RH001', 'nom' => 'KOUAME', 'prenom' => 'Awa', 'role' => 'ROLE_GESTIONNAIRE_RH', 'structure' => 'DRH'],
            ['matricule' => 'SD001', 'nom' => 'BROU', 'prenom' => 'Marc', 'role' => 'ROLE_SOUS_DIRECTEUR', 'structure' => 'SD-PERS'],
            ['matricule' => 'DIR001', 'nom' => 'KONE', 'prenom' => 'Ibrahim', 'role' => 'ROLE_DIRECTEUR', 'structure' => 'DSI'],
            ['matricule' => 'DRH001', 'nom' => 'ADJOUA', 'prenom' => 'Marie', 'role' => 'ROLE_DRH', 'structure' => 'DRH'],
            ['matricule' => 'SEC001', 'nom' => 'YAPO', 'prenom' => 'Chantal', 'role' => 'ROLE_SECRETAIRE', 'structure' => 'CAB'],
            ['matricule' => 'SVC001', 'nom' => 'DIALLO', 'prenom' => 'Aminata', 'role' => 'ROLE_SERVICE_ADMINISTRATIF', 'structure' => 'DRH'],
            ['matricule' => 'CHEF001', 'nom' => 'TRAORE', 'prenom' => 'Siaka', 'role' => 'ROLE_CHEF_DE_SERVICE', 'structure' => 'SERV-ETUDES'],
            ['matricule' => 'CAB001', 'nom' => 'N_GUESSAN', 'prenom' => 'Koffi', 'role' => 'ROLE_DIRECTEUR_CABINET', 'structure' => 'CAB'],
            ['matricule' => 'ADM001', 'nom' => 'SYSADMIN', 'prenom' => 'Root', 'role' => 'ROLE_ADMIN_DSI', 'structure' => 'DSI'],
            // Comptes historiques du frontend d'origine (mêmes matricules).
            ['matricule' => '000001X', 'nom' => 'GRAMBOUTE', 'prenom' => 'Mohamed Prince', 'role' => 'ROLE_AGENT', 'structure' => 'SERV-ETUDES'],
            ['matricule' => '000002A', 'nom' => 'KOUASSI', 'prenom' => 'Jean-Marc', 'role' => 'ROLE_GESTIONNAIRE_RH', 'structure' => 'SD-PERS'],
            ['matricule' => '000003B', 'nom' => 'ADJOUA', 'prenom' => 'Marie-Claire', 'role' => 'ROLE_DRH', 'structure' => 'DRH'],
            ['matricule' => '000004Z', 'nom' => 'KONE', 'prenom' => 'Ousmane', 'role' => 'ROLE_ADMIN_DSI', 'structure' => 'DSI'],
        ];

        foreach ($comptes as $c) {
            $agent = Agent::firstOrCreate(['matricule' => $c['matricule']], [
                'civilite' => 'M.',
                'nom' => $c['nom'],
                'prenom' => $c['prenom'],
                'structure_id' => Structure::where('code', $c['structure'])->first()->id,
            ]);
            $user = User::firstOrCreate(['matricule' => $c['matricule']], [
                'name' => $agent->fullName(),

<!DOCTYPE html><html lang="fr"><head><meta charset="utf-8"><title>Dashboard admin</title><script src="https://cdn.tailwindcss.com"></script></head>
<body class="bg-slate-50 p-8"><h1 class="font-extrabold text-xl">Espace admin</h1>

...
@if ($errors->any())<p class="text-xs text-red-600 font-bold">{{ $errors->first() }}</p>@endif
<input name="matricule" value="{{ old('matricule') }}" placeholder="Matricule (ex: AGT001)" class="w-full border rounded p-2 text-sm" required>
